class QuotationDetailMiddleClassificationsController < ApplicationController
  ...
  def save_price_to_headers_move(line_number)
    ...
    if quotation_header.present? 
      ...
      #upd230616
      total_price_large = QuotationDetailLargeClassification.where(["quotation_header_id = ?", params[:quotation_header_id]]).sumpriceQuote
      quotation_header.quote_price = total_price_large
