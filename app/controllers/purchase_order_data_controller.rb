class PurchaseOrderDataController < ApplicationController
  ...
  def update_constant
    ...
    if constant.blank?
      ...
      constant.id = 1
      constant.purchase_order_last_header_code = "A0000"
      constant.save!
        
      #constant_params = {purchase_order_last_header_code: "A0000"}
      #constant = Constant.create(constant_params)
    end
    #
    
    if @purchase_order_datum.purchase_order_code.present?
