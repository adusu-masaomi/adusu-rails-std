class OutsourcingCostsController < ApplicationController
  ...
  def update_purchase_data_payment_flag
    ...
    if purchase_data.present? && closing_date.present?  #add230629
    ...
    if purchase_data.present?  #add230629
  ...
  private
    ...
    def outsourcing_cost_params
      ...
      params.require(:outsourcing_cost).permit(:purchase_order_datum_id, :construction_datum_id, :staff_id, :supplier_master_id, 
                     :purchase_amount, :supplies_expense, 
