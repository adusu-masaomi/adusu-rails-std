class ConstructionDailyReportsController < ApplicationController
  ...
  def get_working_time
    ...
    #１日の就業時間を計算
    @working_hour = get_working_hour(@working_time_start_time, @working_time_end_time,
                         @break_time_1_start_time, @break_time_1_end_time, 
                         @break_time_2_start_time, @break_time_2_end_time, 
                         @break_time_3_start_time, @break_time_3_end_time )
    
  end
  
  def get_working_hour(start_time, end_time, 
                       break_time_1_start_time, break_time_1_end_time,
                       break_time_2_start_time, break_time_2_end_time,
                       break_time_3_start_time, break_time_3_end_time )
    ...
    break_time_1 = break_time_1_end_time - break_time_1_start_time
    break_time_2 = break_time_2_end_time - break_time_2_start_time
    break_time_3 = break_time_3_end_time - break_time_3_start_time
    ...
    #end_time = time_to_seconds(start_time.hour, end_time.min)
  end
  ...
  private
    ...
    def construction_daily_report_params
        params.require(:construction_daily_report).permit(:working_date, :construction_datum_id, :staff_id, :start_time_1, :end_time_1, 
                   ...
                   :is_one_day_work, :is_no_break_time_1, :is_no_break_time_2, :is_no_break_time_3 )
    end
