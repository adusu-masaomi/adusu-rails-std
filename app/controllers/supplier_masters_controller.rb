class SupplierMastersController < ApplicationController
  ...
  def create
    ...
    #住所のパラメータ変換
    params[:supplier_master][:address] = params[:addressX]
  ...
  private
    ...
    def supplier_master_params
      params.require(:supplier_master).permit(:supplier_name, :tel_main, :fax_main, :email_main, :responsible1, :email1, 
           ...
           :search_character, :outsourcing_flag, :post, :address, :bank_name, :bank_branch_name,
           :account_type, :account_number, :holder, :responsible_title, :responsible_name, 
