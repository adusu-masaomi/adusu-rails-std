class LaborCostSummaryAdusuPDF
  ...
  #労務集計表PDF発行
    ...
    report = Thinreports::Report.new(layout: "#{Rails.root}/app/pdfs/labor_cost_summary_adusu_pdf.tlf")
    ...
    @exist_okado = exist_okado(construction_daily_reports)  #岡戸がいるかいないかのチェック
